...
def verify_assets(timestamps=None, audio_file=SAVE_VOICEOVER_TO, images_dir=None):
    ...
    # Use provided images_dir or fall back to imported value
    img_dir = images_dir if images_dir else SAVE_IMAGES_TO
    
    missing_images = []
    for i in range(1, len(timestamps) + 1):
        image_path = f"{img_dir.rstrip('/')}/image_{i}.jpg"
